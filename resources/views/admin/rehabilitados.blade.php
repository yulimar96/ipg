@extends('layouts.app', ['activePage' => 'Rehabilitados', 'titlePage' => __('Rehabilitados')])
@section('content')
    <!-- Contenido -->
    <div class="row pt-4">
        <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class=" text-center">Detalles de la Rehabilitación de los Pozos</h5>
                                ...
                                <table class="table table-bordered table-striped dataTable dtr-inline bg-info" role="grid"
                                    ...
                                    <thead class="text-center text-white">
                                        <tr>
                                            ...
                                            <th class="">Fecha de Rehabilitación</th>
                                            <th class="">Estado</th>                                            
                                            <th class="">Producción</th>
